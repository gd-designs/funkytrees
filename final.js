...
document.addEventListener("DOMContentLoaded", () => {
  ...
  var animation = lottie.loadAnimation({
    ...
    loop: false,
    autoplay: false,
    path: "https://assets-global.website-files.com/65e2ff11683fe19430c281d5/66017f441e46dbba33fa4d1d_Frame%206%20(1).json",
  });
  ...
  var treeGrowBig = lottie.loadAnimation({
    ...
    loop: false,
    autoplay: false,
    path: "https://assets-global.website-files.com/65e2ff11683fe19430c281d5/6601956c1baaa5cef886a981_Frame%2013%20(4).json",
  });
  ...
  function animateSlide0() {
    ...
    new SplitType(".text-slide-1", { types: "lines", tagName: "span" });
    tl.fromTo(
      ".text-slide-1 .line",
      {
        rotateX: -90,
  ...
  function animateSlide1() {
    ...
    tl.fromTo(".wheel.is-2", { x: "0vw" }, { x: "-100vw", duration: 2 })
      ...
      .fromTo(
        ".grass-1-slide-2, .grass-2-slide-2, .grass-3-slide-2, .grass-4-slide-2, .grass-5-slide-2",
        { autoAlpha: 0 },
        { autoAlpha: 1, duration: 0.5, ease: "power2.out", stagger: 0.2 },
        0.25
      )
      .fromTo(
        ".star-1-slide-2",
    ...
    new SplitType(".text-slide-2", { types: "lines", tagName: "span" });
    tl.fromTo(
      ".text-slide-2 .line",
      {
        rotateX: -90,
  ...
  function animateSlide2() {
    ...
    // SplitType animation starts immediately after the previous animation
    new SplitType(".text-slide-3", { types: "lines", tagName: "span" });
    tl.fromTo(
      ".text-slide-3 .line",
      {
        rotateX: -90,
  ...
  function animateSlide3() {
    ...
    new SplitType(".text-slide-4", { types: "lines", tagName: "span" });
    tl.fromTo(
      ".text-slide-4 .line",
      {
        rotateX: -90,
  ...
  function animateSlide0Mobile() {
    ...
    const textTimelineMobile = gsap.timeline({ repeat: -1 });
  ...
  function animateSlide1Mobile() {
    ...
    tl.fromTo(".wheel.is-2", { x: "0vw" }, { x: "-100vw", duration: 2 })
      ...
      .to(".wheel.is-1", { x: "0vw", duration: 0 })
      .fromTo(
        ".grass-1-slide-1, .grass-2-slide-1, .grass-3-slide-1, .grass-4-slide-1, .grass-5-slide-1",
        { autoAlpha: 1 },
        { autoAlpha: 0, duration: 0, ease: "power2.out" },
        0
      )
    ...
    tl.fromTo(
      ".sunrise-wrap-slide-2",
      { x: "10vw", y: "10vh" },
      { x: "0vw", y: "50vh", duration: 10, ease: "power2.out" },
      0.5
    )
      .fromTo(
        ".sun-glow-slide-2",
