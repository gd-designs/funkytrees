...
document.addEventListener("DOMContentLoaded", function() {
    ...
    const animateScene = (index) => {
        ...
        switch (index) {
            ...
            case 1:
                // Scene 2 animations
                tl.fromTo(".sunrise-wrap-slide-2, .sunrise-wrap-slide-1", { y: -400, x: -200 }, { y: -150, x: -700, duration: 8, ease: "power2.out" })
                  .fromTo(".sun-glow-slide-2", { scale: 1 }, { scale: 0.5, duration: 1, ease: "power2.out" }, 0.5)
              ...
              .fromTo(
                ...
                0
                  ...
                  .fromTo(".sapling-full-slide-2", { height: "0%", opacity: 1 }, { height: "100%", opacity: 1, duration: 8, ease: "power2.out" }, 0);
                break;
            case 2:
                // Scene 3 animations
                tl.fromTo(".sunrise-wrap-slide-2", { y: -150, x: -700 }, { y: 25, x: -900, duration: 1.5, ease: "power2.out" }, 0)
